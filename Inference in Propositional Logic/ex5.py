...
class Propostional_Logic:
    ...
    def is_tautology(self,expression):
        ...
        if(tautology==4):
            print("**  Given Expression ",expression," is Tautology\n")
        elif(contradiction==4):
            print("**  Given Expression",expression," is not Tautology (Contradiction)\n")
        else:
            print("**  Given Expression",expression," is not Tautology (Contingent)\n")
    ...
    def are_equivalent(self,expression1,expression2):
        ...
        if(result1==result2):
            print("Given Two Expressions are Logically Equivalent\n")
        else:
            print("Given Two Expresssions are not Logically Equivalent\n")


print()
while(True):
    print("1) Tautology Check\n2) Logically Equivalent Check\n3) Exit\n")
